...
namespace LFG.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,CreatedDate,Content,PosterProfile")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,CreatedDate,Content,PosterProfile")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
