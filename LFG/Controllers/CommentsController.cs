...
namespace LFG.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CommentContent,Date,CommentingProfile")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CommentContent,Date,CommentingProfile")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
