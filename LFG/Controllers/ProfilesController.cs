...
namespace LFG.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nickname,FirstName,LastName,Age,Avatar,DiscordNick,JoiningDate")] Profile profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nickname,FirstName,LastName,Age,Avatar,DiscordNick,JoiningDate")] Profile profile)
        {
            if (id != profile.Id)
            {
                return NotFound();
