...
namespace LFG.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GameId,GameName,NicknameIngame,HoursPlayed,Rank,Server,Comments")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GameId,GameName,NicknameIngame,HoursPlayed,Rank,Server,Comments")] Game game)
        {
            if (id != game.GameId)
            {
                return NotFound();
