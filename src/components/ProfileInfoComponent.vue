...
<div class="w-full flex p-10">
  <div class="w-[100px] h-[100px] mr-10">
    <AvatarComponent :avatar="profile.Avatar" :nickname="profile.Nickname"/>
  </div>
...
<script>
import AvatarComponent from "@/components/subcomponents/AvatarComponent.vue";
export default {
